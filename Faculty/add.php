...
<?php 
	...
	if (isset($_POST["submit"]))
	{
                ...
                $sql = "insert into tbl_faculty (fName,fDesignation,fQualification,fEmail,fPhone,fGender,fStatus,fSubcount) VALUES ('".$_POST["fName"]."','".$_POST["fDesignation"]."','".$_POST["fQualification"]."','".$_POST["fEmail"]."','".$_POST["fPhone"]."','".$_POST["fGender"]."','".$_POST["fStatus"]."','".$_POST["fSubcount"]."')";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <option value="">Designation</option>
                                                ...
                                                <option value="Guest Lecturer">Librarian</option>
                                                </select>
											</div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" autofocus name="fEmail" class="form-control" placeholder="mail-id" required />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Enter phone number</label>
                                                <input type="phone" autofocus name="fPhone" class="form-control" placeholder="phone no" required />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            <div class="form-group">
                                           ...
                                           <!-- <div class="form-group">
												<label for="exampleInputEmail1">Enter gender (f-Female,m-Male)</label>
                                                <input type="text" autofocus name="fGender" class="form-control" placeholder="female/male" required />
												<p style = "color: red;"><?php echo $errMsg; ?></p>  
											</div>-->
                                            <div class="form-group">
												<label for="exampleInputEmail1">Enter the number of subjects</label>
                                                <input type="int" autofocus name="bfSubcount" class="form-control" placeholder="No of subjects" required />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
