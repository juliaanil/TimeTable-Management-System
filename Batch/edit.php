									...
									<div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus name="bFrom" class="form-control"  required value="<?php echo $bFrom; ?>" />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Enter To Date</label>
                                                <input type="text" autofocus name="bTo" class="form-control"  required value="<?php echo $bTo; ?>" />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
