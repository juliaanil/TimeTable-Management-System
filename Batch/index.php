...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <?php
                        ...
                        <td style="justify-content:center; text-align:center" width="20%"> <?php echo $row["bFrom"]; ?> </td>
                        <td style="justify-content:center; text-align:center" width="20%"> <?php echo $row["bTo"]; ?> </td>
