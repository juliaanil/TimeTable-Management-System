    ...
    <div class="card-body">
        ...
        <?php
                        ...
                        <td style="justify-content:center; text-align:center" width="5%"> 
                            <input  type="checkbox"  style="vertical-align:bottom;width:14px;height:15px" class="checkbox-child" name="check_list[]"  value=<?php echo $row['invid']; ?> >
                    ...
                    ?>
                        ...
                        <td style="justify-content:center; text-align:center" width="20%"> <?php echo $row["date"]; ?> </td>
                        <td style="justify-content:center; text-align:center" width="20%"> <?php echo $row["day"]; ?> </td><td style="justify-content:center; text-align:center" width="5%"> 
                            <?php 
                                if($row["status"]==1) {?>
                        ...
                        <td style="justify-content:center; text-align:center" width="20%"> <?php echo $row["session"]; ?> </td>
                          ...
                          <td style="justify-content:center; text-align:center" width="10%"> 
                            <a href="edit.php?invid=<?php echo $row['invid'] ?>"  style="background-color:white;" class="btn btn-light a-btn-slide-text">
                        ...
                        <!-- Delete button -->
                        <td style="justify-content:center; text-align:center" width="10%"> 
                            <a href="delete.php?id=<?php echo $row['invid']; ?>" onclick="return confirm('Are you sure you want to delete?')" 
