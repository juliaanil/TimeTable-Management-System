<?php 
	...
	if (isset($_POST["submit"]))
	{
        ...
        // exit;
           ...
           $sql = "insert into tbl_mentoring(bid,day) values ($bid,'$day')";
           if($db->query($sql) == TRUE)
           {
               $_SESSION['msg'] = "Mentor allocation successful!";
								...
								<div class="card mt-4  bg-white	">
									...
									<div class="card-body">
										<form action="" method="POST">
                                            ...
                                            <div class="form-group">
												 <label for="exampleInputEmail1">Select Faculty</label> <br>
