...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800 text-center">MENTORING MANAGEMENT</h1>
<div>
    <?php  
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <?php
                        $sql1="select * from tbl_mentoring";
                        ...
                        <td style="justify-content:center; text-align:center" width="5%"> 
                            <input  type="checkbox"  style="vertical-align:bottom;width:14px;height:15px" class="checkbox-child" name="check_list[]"  value=<?php echo $row['mid']; ?> >
                                  
                        </td>
                        
                        </form>
                        <?php  $sql2="select bName from tbl_batch where bid in (select bid from tbl_mentoring where mid=$mid)"; 
                    ...
                    ?>
                       <!-- <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["day"]; ?> </td>-->
                       
                         <!-- View button -->
                         <td style="justify-content:center; text-align:center" width="10%"> 
                            <a href="view.php?bid=<?php echo $row['bid']?>"  style="background-color:white;" class="btn btn-light a-btn-slide-text">
                        ...
                        <!-- Delete button -->
                        <td style="justify-content:center; text-align:center" width="10%"> 
                            <a href="delete.php?bid=<?php echo $row['bid']; ?>" onclick="return confirm('Are you sure you want to delete?')" 
