<?php 
    ...
    if (isset($_POST["submit"]))
	{
                ...
                $sql = "insert into tbl_subject(subname,subtype,pid,semid) VALUES ('".$_POST["subname"]."','".$_POST["subtype"]."','".$_POST["pName"]."','".$_POST["semid"]."')";
									...
									<div class="card-body">
										<form action="" method="POST">
											<div class="form-group">
                                               ...
                                               <td>
                                               <input type="radio" name="subtype" value="1"/>Theory
