<?php 
	...
	{    
        ...
        $newsemid=$_POST['semid'];
                ...
                $sql = "update tbl_subject set subname='$newsubname',subtype='$newsubtype',pid='$newpid',semid='$newsemid' where subid='$subid'";
                
                if($db->query($sql) == TRUE)
                { 
                $_SESSION['msg'] = "Subject $newpid updated successfully!";
								...
								<div class="card mt-4  bg-white	">
									...
									<div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
												<label for="exampleInputEmail1">Enter Subject type (1-Theory,0-Practical)</label>
                                               <!-- <input type="text" autofocus name="bName" class="form-control" placeholder="<?php echo $subtype; ?>" required />-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <!-- <input type="text" autofocus name="bName" class="form-control" placeholder="<?php echo $newsemid; ?>" required />-->
