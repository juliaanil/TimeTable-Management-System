...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800 text-center">TIMETABLE MANAGEMENT</h1>
<div>
    <?php  
...
<div class="card shadow mb-4">
    ...
    <form action="algorithm.php" method="POST">
        <div style="float:right;" class="font-weight-bold text-right">
            ...
            <span width=400><strong>Generate Timetable</strong></span>
            </a>
        </div>
        </form>
        ...
        <div style="float:right;" class="font-weight-bold text-right">
            <button type="submit" class="btn-sm btn-primary a-btn-slide-text">
            <span class="glyphicon glyphicon-edit fas fa-info" aria-hidden="true"></span>
            <span width=400><strong>Show Timetable</strong></span>
            </a>
        </div>
        </form>
